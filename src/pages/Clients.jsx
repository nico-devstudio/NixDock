...
export default function Clients() {
  ...
  const primaryButt =
    "flex items-center self-start max-md:self-center gap-2 px-4 py-2 rounded-lg text-white bg-blue-600 transition-colors hover:bg-blue-700";
  const deleteButt =
  ...
  return (
    <div className="max-w-5xl">
      <div className="flex max-md:flex-col max-md:items-center justify-between mb-5">
      ...
      <p className="text-sm text-gray-700 mb-10 max-md:text-center">
